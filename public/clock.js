...
define(function(require) {
	...
	require('plugins/ciscoZeus-clock/clock.css');

	// Create an Angular module for this plugin
	var module = require('ui/modules').get('ciscoZeus-clock');
	...
	function ClockProvider(Private) {
		...
		return new TemplateVisType({
			name: 'czClock', // the internal id of the visualization
			title: 'czClock', // the name shown in the visualize list
			icon: 'fa-clock-o', // the class of the font awesome icon for this
			description: 'Add ciscoZeus-clock to your dashboards.', // description shown to the user
			requiresSearch: false, // Cannot be linked to a search
			template: require('plugins/ciscoZeus-clock/clock.html'), // Load the template of the visualization
			params: {
				editor: require('plugins/ciscoZeus-clock/clock-editor.html'), // Use this HTML as an options editor for this vis
